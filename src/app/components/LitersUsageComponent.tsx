      ...
      <div className="">
        <div className="min-w-0 rounded-lg shadow-xs overflow-hidden bg-white bg-gray-800">
          ...
          <div className="p-4 flex items-left">
            <div className="p-3 mr-5 rounded-full icon-circle text-green-200 text-green-100 bg-green-100 bg-green-500">
              <FontAwesomeIcon
                icon={faShower}
        ...
        <div className="min-w-0 rounded-lg shadow-xs overflow-hidden bg-white bg-gray-800">
          <div className="p-4 flex items-left">
            <div className="p-3 mr-5 rounded-full icon-circle text-orange-100 bg-orange-100 bg-orange-500">
              <FontAwesomeIcon
                icon={faDroplet}
        ...
        <div className="min-w-0 rounded-lg shadow-xs overflow-hidden bg-white bg-gray-800">
          <div className="p-4 flex items-left">
            <div className="p-3 mr-5 rounded-full icon-circle text-blue-200 dark:text-blue-100 bg-blue-100 bg-blue-500">
              <FontAwesomeIcon
                icon={faToilet}
        ...
        <div className="min-w-0 rounded-lg shadow-xs overflow-hidden bg-white bg-gray-800">
          <div className="p-4 flex items-left">
            <div className="p-3 mr-5 rounded-full icon-circle text-teal-200 dark:text-teal-100 bg-teal-100 bg-teal-500">
